...
export default function GeneraContenidos() {
  return (
    <Box
      sx={{
        minHeight: '100vh',
        py: { xs: 4, md: 2 }, // 🔹 más arriba, más pegado a la navbar
        px: { xs: 3, md: 6 },
    ...
    >
      ...
      <MotionBox
        ...
        sx={{
          ...
          border: '1px solid rgba(0,255,136,0.3)', // 🔹 nuevo verde neón más brillante
          boxShadow: '0 0 30px rgba(0,255,136,0.25)', // 🔹 mismo color neón actualizado
            ...
            >
              <CardContent>
                ...
                <Typography variant="body2" sx={{ color: '#C260FF' }}>
                  Si además adquieres tu membresía tus ganancias son mayores. Entra ya a marihuanas.club
                </Typography>
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        '&:hover': {
                          borderColor: '#A6FF00',
                          color: '#A6FF00',
                          boxShadow: '0 0 15px rgba(166,255,0,0.4)'
                        }
                      }}
                      onClick={() =>
                        navigator.share
                          ? navigator.share({ title: 'marihuanas.club', url: 'http://marihuanas.club' })
                          : null
                      }
                    >
                      Compartir
          ...
          <Grid item xs={12} md={5}>
            ...
            >
              ...
              <Card sx={{ p: 3, borderRadius: 3, background: 'linear-gradient(90deg,#A6FF00,#00FFD1)', color: '#051322', textAlign: 'center', fontWeight: 900 }}>
                <Typography variant="h4">5–25</Typography>
