...
const [autoresMap, setAutoresMap] = useState({});
  ...
  async function fetchContenidos(filtros, parametros) {
    try {
      setLoading(true);
      let urlFiltrada = `${STRAPI_URL}/api/tareas?populate=autor,autor_nombre,autor_email,galeria_libre,galeria_restringida,videos_libres,videos_restringidos,categoria`;
